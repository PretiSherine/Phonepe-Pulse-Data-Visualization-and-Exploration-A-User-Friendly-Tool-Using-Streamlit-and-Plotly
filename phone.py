...
def state_list():
    gopi = psycopg2.connect(
        host='localhost', user='postgres', password='preti@01', database='phonepe')
    cursor = gopi.cursor()
...
class data_extraction:
    ...
    def aggregated_transaction():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/aggregated/transaction/country/india/state/"
    ...
    def aggregated_user():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/aggregated/user/country/india/state/"
            agg_state_list = os.listdir(path)
    ...
    def map_transaction():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/map/transaction/hover/country/india/state/"
            agg_state_list = os.listdir(path)
    ...
    def map_user():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/map/user/hover/country/india/state/"
            agg_state_list = os.listdir(path)
    ...
    def top_transaction_district():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/top/transaction/country/india/state/"
            agg_state_list = os.listdir(path)
    ...
    def top_user_district():
        try:
            path = "C:/Users/Preti Sherine/OneDrive/Desktop/youtube warehousing/phonepe/pulse/data/top/user/country/india/state/"
            agg_state_list = os.listdir(path)
...
class data_load:
    ...
    def sql_table_creation():
        gopi = psycopg2.connect(host='localhost', user='postgres', password='preti@01', database='phonepe')
        cursor = gopi.cursor()
...
class state:
    ...
    def original_state_list():
        gopi = psycopg2.connect(host='localhost', user='postgres',
                                password='preti@01', database='phonepe')
        cursor = gopi.cursor()
